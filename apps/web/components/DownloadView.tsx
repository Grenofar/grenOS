...
const FR = {
  ...
  vbox: [
    ...
    "La démarrer. Le bureau arrive tout seul, sans mot de passe, et tout ce que tu fais est gardé sur le disque de la machine.",
